  ...
  const speedDialActions = [
    {
      ...
      label: 'Quick Note',
      icon: FileText,
      color: 'bg-chart-4 hover:bg-chart-4/90 text-primary-foreground shadow-xs',
    ...
    },
    {
      ...
      label: 'Voice Memo',
      icon: Mic,
      color: 'bg-destructive hover:bg-destructive/90 text-destructive-foreground shadow-xs',
