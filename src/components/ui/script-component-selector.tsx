      ...
      <CardContent className="space-y-3">
        {options.map((option, index) => (
          <div
            key={option.id}
            className={cn(
              "relative p-4 rounded-lg border-gray-200 cursor-pointer transition-all duration-200",
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className={cn(
                "w-5 h-5 rounded-full border-gray-200 flex items-center justify-center ml-3 flex-shrink-0",
                selected?.id === option.id
