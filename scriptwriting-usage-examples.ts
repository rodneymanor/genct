...
async function exampleBatchProcessing() {
  ...
  const videoIdeas = ["5 habits that changed my life", "Why I quit my 9-5 job", "How to learn any skill in 30 days"];
...
// Example usage:
// Uncomment any of the example functions above to test them
// exampleBasicScriptGeneration().catch(console.error);
// exampleCompleteWorkflow().catch(console.error);
// exampleTranscriptToScript().catch(console.error);
// exampleCustomSelection().catch(console.error);
// exampleCostCalculation().catch(console.error);
